...
//*****************************************************************************
//
// Copyright 2014-2015, 2018-2019, 2020, 2021, 2023 NXP
//
...
#if defined(SECTOR_HASHING_ARMV8)
...
#endif
#if defined (BLANK_CHECK)
				} else if (cmd & FOP_BLANK_CHECK_SECTOR) {
					resultCode = BlankCheckSectors(
							msg->param[FOPARG_BLANKCHECK_FADDR],
							msg->param[FOPARG_BLANKCHECK_SECTORS]);
#endif
