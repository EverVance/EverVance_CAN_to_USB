...
C_DEPS += \
./QSPIsource/flexspi_QSPI_flash.d 

OBJS += \
./QSPIsource/flexspi_QSPI_flash.o 


# Each subdirectory must supply rules for building sources it contributes
QSPIsource/%.o: ../QSPIsource/%.c QSPIsource/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-QSPIsource

clean-QSPIsource:
	-$(RM) ./QSPIsource/flexspi_QSPI_flash.d ./QSPIsource/flexspi_QSPI_flash.o

.PHONY: clean-QSPIsource
